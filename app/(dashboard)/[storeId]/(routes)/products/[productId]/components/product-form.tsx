							...
							render={({ field }) => (
								<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
									...
									<div>
										...
										<FormDescription>
											Sản phẩm sẽ được xuất hiện trên trang chủ
										</FormDescription>
									</div>
								</FormItem>
							)}
							...
							render={({ field }) => (
								<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
									...
									<div>
										...
										<FormDescription>
											Sản phẩm sẽ KHÔNG xuất hiện trên toàn bộ hệ thống cửa hàng
										</FormDescription>
									</div>
								</FormItem>
							)}
